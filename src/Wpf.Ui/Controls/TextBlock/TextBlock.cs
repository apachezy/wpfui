...
public class TextBlock : WinTextBlock
{
    ...
    ///
    /// <para>
    /// Although declared on <see cref="UiTextBlock"/>, this property is an
    ...
    /// </example>
    /// </remarks>
    public static readonly DependencyProperty FontTypographyProperty = DependencyProperty.RegisterAttached(
