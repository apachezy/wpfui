...
internal static class TextBlockTheming
{
    ...
    /// </summary>
    public static readonly DependencyProperty AppearanceForegroundProxyProperty = DependencyProperty.RegisterAttached(
    ...
    /// </summary>
    public static readonly DependencyProperty FontTypographyProxyProperty = DependencyProperty.RegisterAttached(
        "FontTypographyProxy",
